...
# ✅ Use localhost:29092 because producer runs on your host machine
...
while True:
    event = {
        "transaction_id": str(uuid.uuid4()),  # typo fixed: transition_id → transaction_id
    ...
    # ✅ Send to the correct topic (payments.raw)
